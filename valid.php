...
$a=$_POST["username"];
$b=$_POST["password"];
$logid="SELECT `logid` FROM `login` WHERE `username`='$a' and `password`='$b' ";
...
$r="SELECT * FROM employee WHERE logid = '$l' ";
$result = mysqli_query($con,$r);
if(mysqli_num_rows($result) == 0) {
   //  header("Location: registration.php");
	 require($_POST['action'] . "index.html");
} else {
    // header("Location: index-slider.html");
	require($_POST['action'] . "index-slider.html");
}
