...
$sql1="INSERT INTO `login`(`username`, `password`, `email`, `user_type`, `apstatus`, `status`) VALUES ('$h','$i','$ed','d','a',1)";
$result1=mysqli_query($con,$sql1) or die("error");
//echo "<script> alert('login');</script>";
$logid="SELECT `logid` FROM `login` WHERE `email`='$ed'";
...
$sql="INSERT INTO `developer`(`name`, `age`, `gender`, `address`, `phone`, `email_id`, `language`, `previous`, `status`, `photo`, `logid`) VALUES ('$a','$b','$che','$d','$ep','$ed','$e','$f','1','$g','$l')";
...
<body>
  ...
  <div class="container__child signup__form">
	...
	<div class="form-group">
        <label for="name"><b>Developer Registration</b></label>
        <input class="form-control" type="text" name="name" id="name" placeholder="name" required />
        <input class="form-control" type="text" name="age" id="age" placeholder="age" required />
        <br>
		Gender:         <input  type="radio"  name="gender" text="female" value="female">Female
        <input  type="radio"  name="gender" text="male"   value="male">Male
      ...
      <br>
		Language:        <select name="language" value="language">
...
<br></br>
        Upload your work &nbsp;&nbsp;<input class="form-control" type="file" name="previous" id="previous" placeholder="previous" required />
        Choose photo<input class="form-control" type="file" name="photo" id="photo" placeholder="photo" required />
