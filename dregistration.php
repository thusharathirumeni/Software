...
if(isset($_POST['submit']))
{
	...
	$i=$_POST["password"];
	$l=$_SESSION["logid"];
	$sql1="UPDATE `login` SET `username`='$h',`password`='$i',`email`='$ed',`status`='1' WHERE `logid`='$l'";
	$result1=mysqli_query($con,$sql1) or die("error");
	$sql="INSERT INTO `developer`(`name`, `age`, `gender`, `address`, `phone`, `email_id`, `language`, `previous`, `status`, `photo`, `logid`) VALUES ('$a','$b','$che','$d','$ep','$ed','$e','$mp','1','$m','$l')";
	$result=mysqli_query($con,$sql);
	header("location: developer.php");		//header("Location: dregistration.php");
...
<style>
body {
	font: 50% / 1.414 "Open Sans", "Roboto", arial, sans-serif;
	//background:blue;
	background:white;
}
...
<h1 class="heading--primary">Welcome Developer</h1>
...
<form id="dregistration" action="" method="post" enctype="multipart/form-data" onsubmit="return ">
<div class="form-group">
<br></br><br></br><label for="name"><b>Developer Registration</b></label>
<input class="form-control" type="text" name="name" id="name" placeholder="name"  />
<span class="error" id="name_error"></span>

<input class="form-control" type="date" min='01-01-1975' max='01-01-1999'name="age" id="age" placeholder="age"  />
<span class="error" id="age_error"></span>

<br></br>
&nbsp &nbsp Gender:  &nbsp   <input  type="radio" id="gender" name="gender" text="female" value="female">Female
&nbsp <input  type="radio"  name="gender" text="male" id="gender"   value="male">Male
...
<br></br>
&nbsp &nbsp Language:&nbsp&nbsp <select name="language" id="language" value="language">
...
<br></br>
&nbsp &nbsp Upload your work &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  <input class="form-control" type="file" name="previous" id="previous" placeholder="previous"  />
<span class="error" id="previous_error"></span>

&nbsp &nbsp Choose photo<input class="form-control" type="file" name="photo" id="image" placeholder="photo"  />
...
<br>
<li>           <input class="btn btn--form" type="submit" name="submit" value="submit" />
</li></br>
</ul>
</div>
</div>
