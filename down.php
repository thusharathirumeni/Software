...
while($row=mysqli_fetch_array($sql)){
	...
	<tr>
		<td><input class="txts" type="text" style="margin:10px" name="Software_Name" value="<?php echo $row['sname'];?>"></td>
		<td><input class="txt" type="text" style="margin:10px" name="byte" value="<?php echo $row['byte'];?>"></td>
		<td><input class="txt" type="text" style="margin:10px" name="size" value="<?php echo $row['size'];?>"></td>
...
<?php echo $row['description'];?>
		...
		<?php
			if(isset($_SESSION["logid"])){
				?><td><a href="<?php echo $row["software"]; ?>">Download</a></td><?php
			}else {
         ?>
        <td><input type="button" style="margin:10px" name="log" value="Please login to download" onClick="document.location='login.php'"></td><?php
		}
		 ?>
