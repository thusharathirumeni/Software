...
if(isset($_POST['submit']))
{
	...
	{
	if ($password==$o_pass) {
		$sql2="UPDATE `login` SET `password`='$passwordnew' WHERE `logid`='$l'";
    ...
    <div class="grid">
      <form action="#" method="POST" class="form  login">
        <div class="form__field">
          ...
          <input id="o_pass" type="text" name="o_pass" class="form__input" placeholder="Current Password" required>
        </div>

        <div class="form__field">
          <label for="login__password"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lock"></use></svg><span class="hidden">Password</span></label>
          <input id="password" type="password" name="password" class="form__input" placeholder="New Password" required>
        </div>
				<div class="form__field">
          <label for="login__password"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lock"></use></svg><span class="hidden">Password</span></label>
