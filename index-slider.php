      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#eight" class="page-scroll">Policy</a></li><li>
							<li><form action="search.php" method="post">
					  <input type="text" class="page-scroll" style="margin-top:12px;margin-left:0px" name="search_term" placeholder="Search here">
							<input type="submit" class="page-scroll" value="Go" style="background:#f81995;margin-top:12px;margin-right:0px" name="submit">
 ...
 ============================================================================================================================-->
   <section class="main-heading" id="home">
       <div class="overlay">
        ...
        <p class="main-heading-text">Welcome to softtech<br/></p>
        <div class="btn-bar">
...
<footer class="site-footer section-spacing text-center " id="eight">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <p class="footer-links"><a href="#">All Rigth Reserved</a> <a href="#">ThusharaThirumeni</a></p>
      </div>
