		...
		while($row=mysqli_fetch_array($result2))
			{
				...
				$sql="INSERT INTO `customer`(`name`, `email_id`, `status`, `logid`) VALUES ('$a','$c','1','$l')";
...
<body>
  ...
  <div class="container__child signup__thumbnail">
    <div class="thumbnail__logo">
      ...
      <h1 class="logo__text">Soft_tech</h1>
    </div><br>
  ...
  <form id="myFormc" action="" method="post" onsubmit="return">
	<div class="form-group"><br></br>
	<label for="name"><b>Customer Registration</b></label><b></b><br></br>
	  ...
	  <div class="form-group">
        <input class="form-control" id="email" type="text" name="email" id="email" placeholder="Email"   />
      ...
      <div class="form-group">
        <input class="form-control" id="password" type="password" name="password" id="password" placeholder="Password" />
		...
		<br>
          <li>
            <input class="form-submit-button" id="submit" type="submit" name="submit" value="Submit" />
		 </li>
          <li>
            <a class="signup__link" href="index.php">Go To Home</a>
          </li></center>
        </ul>
      </div>
    </form>
