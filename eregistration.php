...
if(isset($_POST['submit']))
{
  ...
  $sql1="UPDATE `login` SET `username`='$u',`password`='$p',`email`='$e',`status`='1' WHERE `logid`='$l'";
  $result1=mysqli_query($con,$sql1) or die("error");
  //echo "<script> alert('login');</script>";

 // $logid="SELECT `logid` FROM `login` WHERE `email`='$e'";
...
//  echo "<script> alert('$l');</script>";
  $sql="INSERT INTO `employee`( `name`, `age`, `gender`, `address`, `email_id`, `photo`, `status`, `phone`, `language`, `experiance`, `logid`) VALUES ('$a','$b','$g','$c','$e','$m',1,'$d','$f','$ll','$l')";
...
<body style="background-color:white;">
  <div class="signup__container">
    <div class="container__child signup__thumbnail">
      ...
      <div class="thumbnail__content text-center">
        <h1 class="heading--primary">Welcome Employee</h1>
    ...
    <div class="container__child signup__form">
      <form id="myForm" action="" method="post" enctype="multipart/form-data" onsubmit="return ">
        <br></br><br></br><br></br><br>
        <label for="name"><b>Employee Registration</b></label><b></b>
  ...
  <option value="cpp ">cpp</option>
        ...
        <input class="form-control" type="text" name="experiance" id="experiance" placeholder="experiance"  />
		<span class="error" id="experiance_error"></span>
        <br> &nbsp &nbsp Photo :<input class="form-control" type="file" name="photo" id="photo" placeholder="photo"  />
		<span class="error" id="photo_error"></span>
        Gender &nbsp:&nbsp <input  type="radio"  name="gender" id="gender" text="male" placeholder="j" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">Female
        &nbsp &nbsp <input type="radio" name="gender" id="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">Male
