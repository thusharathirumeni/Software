...
$sql1="INSERT INTO `login`(`username`, `password`, `email`, `user_type`, `apstatus`, `status`) VALUES ('$u','$p','$e','e','a',1)";
...
$sql="INSERT INTO `employee`( `name`, `age`, `gender`, `address`, `email_id`, `photo`, `status`, `phone`, `language`, `experiance`, `logid`) VALUES ('$a','$b','$g','$c','$e','$h',1,'$d','$f','$g','$l')";
...
<body>
  ...
  <div class="container__child signup__form">
    <form action="#" method="post">
        ...
        <input class="form-control" type="text" name="email" id="passwordRepeat" placeholder="email" required />
        <input class="form-control" type="text" name="language" id="passwordRepeat" placeholder="language" required />
        <input class="form-control" type="text" name="experiance" id="experiance" placeholder="experiance" required />
        Photo <input class="form-control" type="file" name="photo" id="passwordRepeat" placeholder="photo" required />
		Gender : <input  type="radio"  name="gender" text="male" placeholder="j" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">Female
