...
$d=$_POST["cid"];
$l=$_POST["logid"];
$sql2="UPDATE `customer` SET `status`='0' WHERE `cid`='$d'";
...
while($row=mysqli_fetch_array($sql)){
	...
	<tr>
		...
		<input class="txt" type="hidden" name="logid" value="<?php echo $row['logid'];?>">
		<td> <center> <input class="sub" type="submit" name="delete" value="delete"> </center> </td>
	</tr></form>
	<?php
}
?>
